...
export function HotelBookingSidebar({
  ...
  return (
    <aside className="lg:sticky lg:top-24 lg:self-start">
      <div className="overflow-hidden rounded-[18px] border border-border/60 bg-card shadow-[0_18px_42px_-34px_rgba(15,23,42,0.34)]">
        <div className="border-b border-border/60 bg-muted/20 px-4 py-3.5">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-[1.85rem] font-bold leading-none text-foreground">{formatMoney(selectedRate?.currency ?? currency, selectedRate?.amount ?? lowestRate, true)}</p>
        ...
        <div className="space-y-2.5 p-3.5">
          ...
          {selectedBookingHref ? (
            <PreferenceLink href={selectedBookingHref} className="flex w-full items-center justify-center rounded-full bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground shadow-[0_12px_22px_-18px_rgba(37,99,235,0.85)] transition-all hover:bg-primary/90 hover:shadow-[0_16px_26px_-18px_rgba(37,99,235,0.95)]">
              Reserve selected room
            </PreferenceLink>
          ) : (
            <a href="#rooms" className="flex w-full items-center justify-center rounded-full bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground shadow-[0_12px_22px_-18px_rgba(37,99,235,0.85)] transition-all hover:bg-primary/90 hover:shadow-[0_16px_26px_-18px_rgba(37,99,235,0.95)]">
              See availability
            </a>
          )}
