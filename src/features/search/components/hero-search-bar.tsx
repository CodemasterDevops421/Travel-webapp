...
export function HeroSearchBar({ variant = 'default', className, initialValues }: HeroSearchBarProps) {
    ...
    return (
        ...
        >
            <form onSubmit={(e) => { e.preventDefault(); onSearch(); }} className="flex w-full flex-col md:flex-row md:items-stretch transition-all rounded-2xl md:rounded-full bg-white shadow-xl px-2 py-2">
                ...
                {!canSearch ? (
                    <p className={cn(
                        'w-full text-center text-[11px] font-medium pt-1 pb-1',
